...
enum Strings {
    ...
    private static func buildTable() -> [String: [Lang: String]] {
        ...
        add("diag.col.rame",        "Train",                               "Rame")
        add("diag.col.station",     "Station",                             "Station")
        add("diag.col.test",        "Test",                                "Test")
        add("diag.entity.rame",     "Train %@",                            "Rame %@")
        ...
        add("diag.step.portes.interlock","traction interlock",             "asservissement traction")
        add("diag.step.pneu.read",  "pressure sweep",                      "relevé des pressions")
        add("diag.step.pneu.span",  "span vs nominal",                     "écart au nominal")
        ...
        add("diag.portes.reading.movingSuffix"," (moving)",                " (en mvt)")
        add("diag.portes.reading.locked","locked",                         "verrouillé")
        add("diag.portes.reading.violated","INTERLOCK OPEN",               "CHAÎNE OUVERTE")
        add("diag.pneu.reading.sweep","%.1f-%.1f bar",                     "%.1f-%.1f bar")
        add("diag.pneu.reading.span","%.1f%% span",                        "%.1f%% écart")
        add("diag.pneu.reading.records","%d records",                      "%d entrées")
        add("diag.quai.reading.lit","%d lamps OK",                         "%d lampes OK")
