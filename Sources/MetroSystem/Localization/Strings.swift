...
enum Strings {
    ...
    private static func buildTable() -> [String: [Lang: String]] {
        ...
        add("detail.asserv.consigne","Setpoint",                           "Consigne")
        add("detail.asserv.error",  "Speed error",                        "Erreur vitesse")
        add("detail.asserv.accel",  "Acceleration",                       "Accélération")
        add("detail.asserv.dist",   "Distance to MA",                     "Distance cible AM")
        ...
        add("detail.traction.fu",   "Emergency brake",                    "Freinage d'urgence")
        add("detail.sec.exploit",   "OPERATIONS",                         "EXPLOITATION")
        add("detail.exploit.dwell", "Station dwell",                      "Stationnement")
        add("detail.exploit.hold",  "Departure hold",                     "Retenue au départ")
        add("detail.sec.atp",       "ATP / SAFETY CHAIN",                 "ATP / CHAÎNE DE SÉCURITÉ")
        add("detail.atp.doorlock",  "Door interlock",                     "Asservissement portes")
        add("detail.atp.overspeed", "Overspeed governor",                 "Contrôle survitesse")
        add("detail.atp.ma",        "MA margin",                          "Marge d'AM")
        add("detail.atp.brake",     "Service brake",                      "Frein de service")
        add("detail.atp.adhesion",  "Adhesion",                           "Adhérence")
        add("detail.atp.chain",     "Safety chain",                       "Chaîne de sécurité")
        add("detail.atp.ok",        "OK",                                 "OK")
        add("detail.atp.open",      "OPEN",                               "OUVERT")
        add("detail.sec.aux",       "AUXILIARIES",                        "AUXILIAIRES")
        add("detail.aux.mainv",     "Line voltage 750 V",                 "Tension ligne 750 V")
        add("detail.aux.battery",   "Battery",                            "Batterie")
        add("detail.aux.compressor","Compressor pressure",                "Pression compresseur")
        add("detail.aux.comprun",   "Compressor running",                 "Compresseur en marche")
        add("detail.aux.temp",      "Interior temp",                      "Température intérieure")
